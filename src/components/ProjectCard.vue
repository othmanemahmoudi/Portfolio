...
<template>
  <section id="projects" class="min-h-screen flex items-center justify-center py-20">
    ...
    <div class="container noselect"  @click="toggleOpen(true)">
      <div class="canvas">
        ...
        <div id="card">
          <div class="card-content">
            ...
            <!-- 🔥 Dynamic prompt -->
            <p id="prompt">{{ projet || 'HOVER ME' }}</p>

            <!-- 🔥 Dynamic title -->
            <div class="title">{{ title || 'CYBER CARD' }}</div>
            ...
            <div class="subtitle">
              ...
              <span class="highlight">{{ highlight || '3D EFFECT' }}</span>
            </div>
    ...
    <transition name="fade">
      <div
        ...
        @click.self="close"
      >
        <div class="bg-gray-900 text-white p-8 rounded-2xl max-w-lg w-full border border-white/10 relative">
          ...
          <p class="mb-6 text-gray-300">
            Ceci est le contenu de la popin ouverte via VueUse avec useToggle().
          </p>

          <button
            class="px-6 py-3 bg-gradient-to-r from-pink-500 to-yellow-500 rounded-full text-white"
            @click="close"
          >
            Fermer
          </button>
